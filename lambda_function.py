...
def get_welcome_response():
    ...
    session_attributes = {}
    card_title = "Welcome"
    speech_output = "Sure! Let's talk. How are you today? " 
...
def set_emotion_in_session(intent, session):
    ...
    if 'Emotion' in intent['slots']:
        ...
        speech_output = "And why is it that you feel " + \
                        current_emotion + \
                        " today?"
...
"""def get_emotion_from_session(intent, session):
    session_attributes = {}
    reprompt_text = None

    if session.get('attributes', {}) and "currentEmotion" in session.get('attributes', {}):
        current_emotion = session['attributes']['currentEmotion']
        speech_output = "Why do you feel " + current_emotion + \
                        "today?"
        should_end_session = True
    else:
        speech_output = "I'm not sure I understand. " \
                        "You can tell me how you're feeling right now."
        should_end_session = False
...
def on_intent(intent_request, session):
    ...
    if intent_name == "IfeelIntent":
        ...
        return get_emotion_from_session(intent, session)
